...
if($_POST)
{
	$to_Email   	= "luisenriquenovoa@gmail.com"; //Replace with recipient email address
	...
	{
		$output = json_encode(array('type'=>'error', 'text' => 'Oops! Name is too short or empty!'));
		die($output);
	}
	if(!filter_var($user_Email, FILTER_VALIDATE_EMAIL)) //email validation
	{
		$output = json_encode(array('type'=>'error', 'text' => 'Oops! Please enter a valid email!'));
		die($output);
	}
